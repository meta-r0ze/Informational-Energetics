...
The system exist ontop of a \textbf{The Substrate:} \textit{The Medium.} The medium that defines the hard limits (e.g., latency, bandwidth) within which the system must operate.
