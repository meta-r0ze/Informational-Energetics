...
By the principles of algorithmic information theory, independent channels combine additively: non-linear cross-terms represent mutual information, which vanishes when channels are statistically orthogonal. This strictly diagonalizes the lowest-order action. The \textbf{Net Entropic Impedance} ($Z_{IE}$) is therefore the algebraic sum of these contributions:
