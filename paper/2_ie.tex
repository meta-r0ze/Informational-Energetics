...
We formalize this as the \textbf{Selection Principle}:

\begin{mdframed}[linewidth=1pt,linecolor=black,backgroundcolor=gray!10]
    Among all possible configurations, only those that minimize \textbf{Entropic Action} ($S_\Phi$) relative to structural complexity remain observable. The Persistence Value ($P$) quantifies this selection: $P \propto 1/S_\Phi$.
\end{mdframed}
