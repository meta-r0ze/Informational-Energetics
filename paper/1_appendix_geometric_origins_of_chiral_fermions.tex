...
As detailed in \cref{sec:chiral_diode}, the introduction of the time-like metric axis forces the decoupling of the ``Mirror'' sector to preserve norm positivity. The mirror fermions required by $E_8$ symmetry still exist in the mathematical structure of the lattice, but they reside in the orthogonal $D_4$ complement (Sector B).
