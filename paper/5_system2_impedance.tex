...
\begin{equation}
    Z_{TOL} = \frac{\Omega_{valid}}{\Omega_{total}} = \frac{1 \cdot \chi \cdot (R_M - \sigma)}{N^3 \cdot \sigma \cdot R_M} \approx \AlphaInvTOLVal
\end{equation}
...
\begin{split}
    ...
    &=\frac{1}{31 \cdot (5+1) \cdot 43^2} \approx \AlphaInvMARVal
\end{split}
\end{equation}
