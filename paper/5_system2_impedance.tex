...
\CatchFileBetweenTags{\VonKlitzingExperimentalVal}{constants.tex}{VonKlitzingExperimentalVal}
...
\begin{itemize}
    \item \textbf{Experimental Value (CODATA 2022):} \VonKlitzingExperimentalVal
