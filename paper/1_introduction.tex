...
% alpha^-1
We then derive the fine-structure constant as the geometric impedance—the entropic cost of sustaining a topological charge against the $E_8$ lattice flux—matching experimental values. This derivation provides a direct, falsifiable test of the theory: if existence implies specific constraints, the constants of nature must match the unique solutions of those constraints.
