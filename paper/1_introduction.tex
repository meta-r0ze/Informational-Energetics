...
\begin{enumerate}
    \item \textbf{System 0: Requirements.} Map IE to physics, deriving Finiteness, Unitarity, and Causality as necessary for vacuum persistence. (\Cref{sec:System0_vacuum_specification})
    ...
    \item \textbf{System 2: Impedance.} The Standard Model has twenty-six free parameters. We derive the first, the fine-structure constant ($\alpha^{-1}$), as a parameter-free geometric consequence of vacuum persistence and validate against measurement. (\Cref{sec:system2_geometric_impedance})
\end{enumerate}
