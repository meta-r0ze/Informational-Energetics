...
The vacuum is the ideal test case: zero free parameters, maximally precise measurements, and crucially no external environment. It persists against only its own structural possibility.
...
\begin{enumerate}
    ...
    \item \textbf{System 1: Substrate.} Show these requirements uniquely 
