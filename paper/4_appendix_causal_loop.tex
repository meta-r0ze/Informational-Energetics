...
While the $h=1$ constraint restricts $\Delta$ to the Stark-Heegner numbers, the final selection of $\Delta = 43$ is enforced by the Self-Clocking phase-lock limit derived in \cref{sec:fundamental_resonance}.