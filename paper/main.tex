...
\input{4_appendix_causal_loop}

\end{document}

% Publishing target: nlin.AO (Adaptation and Self-Organizing Systems) with possible cross to physics.gen-ph (General Physics) For a journal 'Complexity' or 'Foundations of Physics'
