...
System 0 asks: \emph{What geometric properties must a substrate possess to satisfy the three existential requirements of IE (Finiteness, Unitarity, and Causality) when no external memory, boundary conditions, or synchronization signals are available?}
...
\subsection{Persistence Requires Unitarity for \texorpdfstring{$\mathrm{MAP}, \mathrm{PRO}$}{MAP, PRO}}
\label{sec:unitarity}
