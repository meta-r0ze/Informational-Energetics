...
System 0 asks: \emph{What geometric properties must a substrate possess to satisfy the three existential requirements of IE (Finiteness, Conservation, and Causality) when no external memory, boundary conditions, or synchronization signals are available?}
