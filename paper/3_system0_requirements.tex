...
For the vacuum to persist, it must maintain a stable Map over time. This requires that information is perfectly conserved. By the Closure Constraint, the vacuum must be a perfectly closed and lossless information network, making Unitarity a structural necessity, corresponding to the Map and Protocol pillars. This requirement imposes four structural properties on the substrate:
