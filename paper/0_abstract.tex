...
non-equilibrium thermodynamics, and control theory, we derive the Universal Architecture of Persistence: a recursive, six-dimensional set of constraints (Capacity, Identity, Protocol, Governor, Temporal Cost, and Persistence Margin) that any system at any scale must satisfy to maintain structural coherence.
