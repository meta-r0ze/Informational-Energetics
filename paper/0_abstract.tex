...
+ \,\underbrace{\frac{1 \cdot \chi \cdot (R_M - \sigma)}{N^3 \cdot \sigma \cdot R_M}}_{\text{Toll}}
+ \,\underbrace{\frac{1}{L_{embed} \cdot (\sigma + 1) \cdot \Delta^2}}_{\text{Margin}}
\]
\noindent where $R_M = D\Delta$ is manifold resolution, $N = 2\cdot\nu$ is node capacity, and $L_{embed} = \nu + \sigma + \chi + 2D$ is embedding load. This calculation yields $\alpha^{-1} = \AlphaInvVal\dots$, agreeing with Morel (2020) within $0.58\sigma$ and CODATA (2022) within $1.68\sigma$. The Von Klitzing Constant ($R_K$) follow as geometric consequences.
\end{abstract}