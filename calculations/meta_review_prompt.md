...
SCOPE-DEFENSE: (cap failure) mentioning derivations outside the paper such as in companion papers should be avoided so reviewers can concentrate on reviewing this paper.
